package myleft.engine
{
	...
	public class AStar
	{
		...
		//====================================
		//地图模型
		private var m_mapModel:MapModel;
		 ...
		 */		
		public function AStar(p_mapModel:MapModel, p_maxTry : int = 500)
		{
			this.m_mapModel = p_mapModel;
		...
		private function getArounds(p_x : int, p_y : int) : Array
		{
			...
			checkX = p_x + 1;
			checkY = p_y;
			var canRight : Boolean = this.m_mapModel.isBlock(p_x, p_y, checkX, checkY) == 1;
			...
			checkX = p_x;
			checkY = p_y + 1;
			var canDown : Boolean = this.m_mapModel.isBlock(p_x, p_y, checkX, checkY) == 1;
			...
			checkX = p_x - 1;
			checkY = p_y;
			var canLeft : Boolean = this.m_mapModel.isBlock(p_x, p_y, checkX, checkY) == 1;
			...
			checkX = p_x;
			checkY = p_y - 1;
			var canUp : Boolean = this.m_mapModel.isBlock(p_x, p_y, checkX, checkY) == 1;
			...
			checkX = p_x + 1;
			checkY = p_y + 1;
			canDiagonal = this.m_mapModel.isBlock(p_x, p_y, checkX, checkY) == 1;
